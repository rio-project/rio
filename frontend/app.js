...
function setBoxStyleVariables(element, style, prefix, suffix) {
  ...
  if (style === null) {
    ...
    variables['stroke-width'] = "".concat(style.strokeWidth, "rem");
    variables['corner-radius-top-left'] = "".concat(style.cornerRadius[0], "rem");
    variables['corner-radius-top-right'] = "".concat(style.cornerRadius[1], "rem");
    variables['corner-radius-bottom-right'] = "".concat(style.cornerRadius[2], "rem");
    variables['corner-radius-bottom-left'] = "".concat(style.cornerRadius[3], "rem");
    variables['shadow-color'] = (0, app_1.colorToCss)(style.shadowColor);
    variables['shadow-radius'] = "".concat(style.shadowRadius, "rem");
    variables['shadow-offset-x'] = "".concat(style.shadowOffset[0], "rem");
    variables['shadow-offset-y'] = "".concat(style.shadowOffset[1], "rem");
  }
...
function commonUpdate(element, state) {
  ...
  if (newWidth !== null) {
    element.style.width = "".concat(newWidth, "rem");
  } else if (newAlignX !== null) {
    element.style.width = 'max-content';
  } else if (newMarginX !== 0) {
    element.style.width = "calc(100% - ".concat(newMarginX, "rem)");
  } else {
    element.style.removeProperty('width');
  }
  if (newHeight != null) {
    element.style.height = "".concat(newHeight, "rem");
  } else if (newAlignY !== null) {
    element.style.height = 'max-content';
  } else if (newMarginY !== 0) {
    element.style.height = "calc(100% - ".concat(newMarginY, "rem)");
  } else {
