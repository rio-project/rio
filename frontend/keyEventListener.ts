...
export type KeyEventListenerState = WidgetState & {
...
export class KeyEventListenerWidget extends WidgetBase {
    ...
    updateElement(
        ...
        let reportKeyDown = deltaState.reportKeyDown ?? this.state.reportKeyDown;
        let reportKeyUp = deltaState.reportKeyUp ?? this.state.reportKeyUp;
        let reportKeyPress = deltaState.reportKeyPress ?? this.state.reportKeyPress;
    ...
    updateChildLayouts(): void {
        ...
        const childInstance = getInstanceByWidgetId(childId);
